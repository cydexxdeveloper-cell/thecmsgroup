...
import { Phone, MessageSquare, MapPin, Building, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#EEF2F1] p-6 sm:p-7 hover:shadow-lg hover:border-[#003F43]/30 transition-all duration-300 flex flex-col justify-between">
      ...
      {leader.phoneFormatted && leader.telUrl && leader.whatsappUrl ? (
        ...
        <div className="pt-4 border-t border-[#EEF2F1] space-y-2.5">
          <div className="text-xs text-[#4B6365] flex items-center justify-between">
            <span className="font-semibold">Direct Routing:</span>
            <span className="font-bold text-[#003F43]">Corporate Inquiries</span>
          </div>

          <Link
            href="#contact-form"
            className="flex items-center justify-center gap-1.5 py-2.5 px-3 bg-[#EEF2F1] hover:bg-[#003F43] text-[#003F43] hover:text-white rounded-lg text-xs font-bold transition-colors group/btn"
          >
